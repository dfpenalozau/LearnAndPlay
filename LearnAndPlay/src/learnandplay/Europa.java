...
public class Europa extends javax.swing.JFrame {
    ...
    public Europa() {
        initComponents();
        File Archivo=new File("Europa.jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Europa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
