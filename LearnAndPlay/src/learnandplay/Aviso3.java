...
public class Aviso3 extends javax.swing.JFrame {
    ...
    public Aviso3() {
        initComponents();
        File Archivo=new File("Ganaste.jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aviso3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
