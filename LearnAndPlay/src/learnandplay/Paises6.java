...
public class Paises6 extends javax.swing.JFrame {
    ...
    private void BotonEcuaadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEcuaadorActionPerformed
       Aviso2 miGrafica=new Aviso2();
        ...
        miJugador.Aciertos=miJugador.Aciertos+1;  // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Paises6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
